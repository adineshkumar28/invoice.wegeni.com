                ...
                <tbody class="quote-item-container">
                    ...
                    @foreach ($quote->quoteItems as $quoteItem)
                        <tr class="tax-tr">
                            ...
                            <td class="table__qty">
                                {{ Form::number('quantity[]', $quoteItem->quantity, ['class' => 'form-control qty-quote', 'id' => 'qty', 'required', 'type' => 'number', 'min' => 1, 'oninput' => "this.value = this.value.replace(/\./g, '').replace(/\D/g, '')"]) }}
                            </td>
                            <td>
            ...
            <div class="col-lg-7 col-sm-12 mt-2 mt-lg-0 align-right-for-full-screen">
                <div class="mb-2 col-xl-5 col-lg-8 col-sm-12 float-right">
                    <label class="form-check form-switch form-check-custom mt-3">
                        ...
                        <input class="form-check-input" type="checkbox" name="discount_before_tax"
                            id="clientDiscounBeforeTax" {{ $quote->discount_before_tax ? 'checked' : '' }}>
                        &nbsp;&nbsp;
                    </label>
                </div>
                <div class="mb-2 col-xl-6 col-lg-8 col-sm-12 float-right">
                    ...
                    <div class="input-group">
                        {{ Form::number('discount', isset($quote) ? $quote->discount : 0, ['id' => 'discountQuoteClient', 'class' => 'form-control ', 'oninput' => "validity.valid||(value=value.replace(/[e\+\-]/gi,''))", 'min' => '0', 'value' => '0', 'step' => '.01', 'pattern' => "^\d*(\.\d{0,2})?$"]) }}
                        <div class="input-group-append" style="width: 210px !important;">
                            {{ Form::select('discount_type', getTranslatedData($discount_type), isset($quote) ? $quote->discount_type : 0, ['class' => 'form-select', 'id' => 'discountTypeQuoteClient', 'data-control' => 'select2']) }}
                        </div>
                    </div>
                </div>
                <div class="mb-2 col-xl-5 col-lg-8 col-sm-12 float-right">
