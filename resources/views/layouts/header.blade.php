                ...
                <div class="d-sm-flex d-none align-items-stretch dropdown me-2">
                    <button class="btn btn btn-icon btn-primary text-white dropdown-toggle hide-arrow ps-2 pe-0"
                        ...
                        <span data-bs-toggle="tooltip" data-bs-placement="top"
                            data-bs-original-title="{{ __('messages.quick_links') }}">
    ...
    <ul class="nav align-items-center">
        @hasrole('admin')
            <li class="px-xxl-3 px-2">
                <a class="btn btn-primary createInvoiceBtn nowrap" href="{{ route('invoices.create') }}"
                    >{{ __('messages.invoice.new_invoice') }}</a>
            </li>
        @endrole
        @hasrole('client')
        ...
        <li class="px-xxl-3 px-2">
            @if (Auth::user()->dark_mode)
                <a href="javascript:void(0)"  title="{{ __('messages.switch_to_light_mode') }}">
                    <i class="fa-solid fa-moon text-primary fs-2 apply-dark-mode"></i>
                </a>
            @else
                <a href="javascript:void(0)"  title="{{ __('messages.switch_to_dark_mode') }}">
                ...
                <div class="dropdown-menu py-7 pb-4 my-2" aria-labelledby="dropdownMenuButton1">
                    ...
                    <ul class="pt-4">
                        ...
                        @if (!session('impersonated_by'))
                            <li>
                                <a href="javascript:void(0)" class="dropdown-item text-gray-900" id="changePassword">
                                    <span class="dropdown-icon me-4 text-gray-600">
