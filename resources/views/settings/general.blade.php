    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-4 mb-5">
                    {{ Form::label('gst_no', getVatNoLabel() . ':', ['class' => 'form-label fs-6 required mb-3']) }}
                    {{ Form::text('gst_no', $settings['gst_no'] ?? null, ['class' => 'form-control ', 'id' => 'gstNumber', 'placeholder' => __('messages.invoice.gstin')]) }}
                </div>
                ...
                <div class="form-group col-sm-4 mb-5">
                    ...
                    <label class="form-check form-switch form-check-custom mt-3">
                        <input class="form-check-input currencyAfterAmount" type="checkbox"
                            name="show_additional_address_in_invoice" id="ShowAdditionalAddress" value="1"
