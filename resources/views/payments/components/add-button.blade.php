<div class="my-3 my-sm-3" wire:ignore>
    <div class="date-picker-space me-2">
        <input class="form-control text-center removeFocus" placeholder="Pick date range" id="paymentDateFilter">
    </div>
</div>
<div class="dropdown my-3 my-sm-3 me-2">
    ...
    <ul class="dropdown-menu export-dropdown">
        <a href="javascript:void(0)" class="dropdown-item"  id="adminPaymentExcelExport">
            <i class="fas fa-file-excel me-1"></i> {{ __('messages.invoice.excel_export') }}
        </a>
        <a href="javascript:void(0)" class="dropdown-item"  id="adminPaymentPdfExport">
