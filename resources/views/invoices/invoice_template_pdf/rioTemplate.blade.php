...
<body style="padding: 0rem 2rem;">
    ...
    <div style="width: 100%;" style="margin-top:-40px !important;">
        ...
        <table style="width:80%;" class="mb-8 mt-5">
            <tr>
        ...
        <div class="mt-5">
            <p class="d-fancy-title mb5"><b>{{ __('messages.client.notes') . ':' }}</b></p>
        ...
        <div class="w-100">
            <div class="w-75">
                ...
                <div class="mb-8">
                    <p class="d-fancy-title mb5"><b>{{ __('messages.invoice.terms') . ':' }}</b></p>
                    <p class="font-color-gray">
                        {!! nl2br($invoice->term ?? __('messages.common.not_available')) !!}</p>
                </div>
                @endif
            </div>
            <div class="w-25 text-end" style="position:relative;margin-left:auto;">
                <p class="d-fancy-title mb5" {{ $styleCss }}="color: {{ $invoice_template_color }}">
