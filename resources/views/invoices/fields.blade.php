<div class="row">
    ...
    <div class="mb-5 col-lg-4 col-sm-12">
        ...
        {{ Form::select('payment_qr_code_id', $paymentQrCodes, $defaultPaymentQRCode ?? null, ['class' => 'form-select io-select2 payment-qr-code', 'data-control' => 'select2', 'placeholder' => __('messages.placeholder.select_payment_qr_code')]) }}
    </div>
    <div class="mb-5 col-lg-4 col-sm-12">
        ...
        <table class="table table-striped box-shadow-none mt-4" id="billTbl">
            ...
            <tbody class="invoice-item-container">
                <tr class="tax-tr">
                    ...
                    <td class="table__qty">
                        {{ Form::number('quantity[]', null, ['class' => 'form-control qty form-control-solid', 'required', 'type' => 'number', 'min' => '0', 'step' => '.01', 'oninput' => "this.value = this.value.replace(/\./g, '').replace(/\D/g, '')"]) }}
                    </td>
                    <td>
            ...
            <div class="mb-2 col-xl-5 col-lg-8 col-sm-12 float-right">
                <label class="form-check form-switch form-check-custom mt-3">
                    ...
                    <input class="form-check-input" type="checkbox" name="discount_before_tax"
                        id="invoicesDiscounBeforeTax" disabled>
                    &nbsp;&nbsp;
                </label>
            </div>
            <div class="mb-2 col-xl-5 col-lg-8 col-sm-12 float-right">
