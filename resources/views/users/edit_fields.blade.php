<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::tel('contact', isset($user)?$user->contact:null, ['class' => 'form-control form-control-solid', 'placeholder' => __('messages.client.contact_no'), 'onkeyup' => 'if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,"")','id'=>'phoneNumber']) }}
    ...
    <div class="col-md-6 mb-5">
        <div class="fv-row">
            <div>
                {{ Form::label('password_confirmation',__('messages.client.confirm_password').':' ,['class' => 'form-label mb-3']) }}
                <div class="position-relative">
                    <input class="form-control form-control-solid"
                           type="password"
    ...
    <div class="mb-5" io-image-input="true">
        ...
        <div class="d-block">
            <div class="image-picker">
                ...
                {{$styleCss}}="background-image: url('{{ !empty($user->profile_image) ? $user->profile_image : asset('assets/images/avatar
.png') }}')">
            </div>
