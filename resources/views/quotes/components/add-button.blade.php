<div class="dropdown d-flex align-items-center my-3 my-sm-3 me-2" wire:ignore>
    <button class="btn btn btn-icon btn-primary text-white dropdown-toggle hide-arrow ps-2 pe-0" type="button"
        id="quoteFilters" data-bs-auto-close="outside" data-bs-toggle="dropdown" aria-expanded="false">
        <p class="text-center">
            <i class='fas fa-filter'></i>
        </p>
    </button>
    <div class="dropdown-menu py-0" aria-labelledby="quoteFilters">
        ...
        <div class="p-5">
            ...
            <div class="mb-5">
                ...
                {{ Form::select('status', getTranslatedData($quoteStatusArr), null, [
                    'class' => 'form-select',
            ...
            <div class="d-flex justify-content-end">
                <button type="reset" class="btn btn-secondary"
                    id="quoteResetFilters">{{ __('messages.common.reset') }}</button>
            </div>
        </div>
    </div>
</div>
