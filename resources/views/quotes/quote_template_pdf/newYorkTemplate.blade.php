    ...
    <div class="container invoice">
        ...
        <div class="details-section">
            <table class="mt-10 w-100">
                ...
                <tbody>
                    <tr>
                        <td class="invoice-date" style="vertical-align:top !important; width:30% !important;">
                            <div class="">
                        ...
                        <td class="billedto"
                            style="vertical-align:top !important; width:34.33% !important; overflow:hidden; word-wrap: break-word; word-break: break-all;">
                        ...
                        <td class="from" style="vertical-align:top !important; width:34.33% !important;">
                            ...
                            @if (!empty($setting['gst_no']))
                                <span><b>{{ getVatNoLabel() . ':' }}&nbsp;</b></span>
                                <span class="text-color">{{ $setting['gst_no'] }}</span><br>
                            @endif
                        </td>
                    </tr>
                </tbody>
        ...
        <div class="regards">
            <p><b>{{ __('messages.setting.regards') . ':' }}</b><br>
                <b
                    {{ $styleCss }}="color: {{ $quote_template_color }}">{{ html_entity_decode(!empty($setting['app_name']) ? $setting['app_name'] : $userSetting['app_name']) }}</b>
            </p>
        </div>
    </div>
</body>
