            ...
            <table class="table table-striped box-shadow-none mt-4" id="billTbl">
                ...
                <tbody class="quote-item-container">
                    <tr class="tax-tr">
                        ...
                        <td class="table__qty">
                            {{ Form::number('quantity[]', null, ['class' => 'form-control qty-quote', 'required', 'type' => 'number', 'min' => '0', 'step' => '.01', 'oninput' => "this.value = this.value.replace(/\./g, '').replace(/\D/g, '')"]) }}
                        </td>
                        <td>
            ...
            <div class="col-lg-7 col-sm-12 mt-2 mt-lg-0 align-right-for-full-screen">
                <div class="mb-2 col-xl-5 col-lg-8 col-sm-12 float-right">
                    <label class="form-check form-switch form-check-custom mt-3">
                        <span class="form-check-label text-gray-600"
                            for="discounBeforeTaxToggle">{{ 'Discount %(applied before tax):' }}</span>
                        <input class="form-check-input" type="checkbox" name="discount_before_tax" id="discounBeforeTax"
                            disabled>
                        &nbsp;&nbsp;
                    </label>
                </div>
                <div class="mb-2 col-xl-6 col-lg-8 col-sm-12 float-right">
                    ...
                    <div class="input-group">
                        {{ Form::number('discount', 0, ['id' => 'discountQuote', 'class' => 'form-control ', 'oninput' => "validity.valid||(value=value.replace(/[e\+\-]/gi,''))", 'min' => '0', 'value' => '0', 'step' => '.01', 'pattern' => "^\d*(\.\d{0,2})?$"]) }}
                        <div class="input-group-append" style="width: 210px !important;">
                            {{ Form::select('discount_type', getTranslatedData($discount_type), 0, ['class' => 'form-select io-select2', 'id' => 'discountTypeQuote', 'data-control' => 'select2']) }}
                        </div>
                    </div>
                </div>
                <div class="mb-2 col-xl-5 col-lg-8 col-sm-12 float-right">
...
<!-- Final Amount Field -->
{{ Form::hidden('final_amount', 0, ['class' => 'form-control', 'id' => 'quoteFinalTotalAmt']) }}
